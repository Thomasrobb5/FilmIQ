// js/script_trivia.js - Fixed index error; single vertical 15-square display; better positioning
...
// Theme configurations: name, image (9 for 3x3)
const themes = [
