...
let guessHistory = [];
const API_KEY = '5aa575a9c26ba83afe8d98db4011c102'; // Move to env variable in production
...
function showGameOver() {
  ...
  const shareText = `🎬 FilmIQ Higher or Lower (${mode === 'opening' ? 'Opening' : 'Gross'}) 🎉 Streak: ${currentStreak}! 🔥 Beat my score? Play at https://filmiq.app/mobile.html`;
...
async function startGame(selectedMode) {
  ...
  DOM.statusContainer.style.display = 'flex';
  await startNewPair();
  updateStatus();
}
